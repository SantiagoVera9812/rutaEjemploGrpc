...
public class RouteGuideUtil {
   ...
   */
  public static List<Feature> parseFeatures(String resourceName) throws IOException {
    try (InputStream input = RouteGuideServer.class.getClassLoader().getResourceAsStream(resourceName)) {
      if (input == null) {
